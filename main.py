    ...
    def go_menu(self, bot, message, menu_id):
        ...
        if menu_id == 0:  # Главное меню
            ...
            message_text = "Перед поиском имеет смысл выбрать 🌎 сферу деятельности мест, которые вы хотите увидеть." \
                           ...
                           " Вас. Вы сможете найти машину от сервиса @BelbekTaxiBot к месту или заказать оттуда" \
                           ...
                           " Для завершения поиска нажмите ОК."
            ...
            wtf_label = " Место ✳️ - это точка на карте, в которой происходит производство или реализация" \
                        ...
                        " Для создания нового места нажмите на кнопку 'Новое место', в открывшемся меню Вам будет" \
